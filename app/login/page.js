        ...
        <div className="social-login-buttons ">
          ...
          <div className="flex flex-col gap-2 min-h-screen  p-10 items-center ">
            ...
            <button
              ...
              className="flex items-center w-64 bg-gray-200 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
            >
              <svg
                className="h-6 w-6 mr-2"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="my-5  text-center">
              <div className="leading-none px-2  text-sm text-white  font-medium   ">
            ...
            <div className="mx-auto max-w-xs flex flex-col items-center">
              ...
              />
              <div className="py-5">
                <button className="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 w-64 flex justify-center ">
                  <svg
              ...
              <p className="mt-6 text-xs text-gray-400 text-center">
                <input type="checkbox" name="" id="" /> I agree to abide by
                GetMeaCoffee
