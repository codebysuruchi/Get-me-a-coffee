...
const page = () => {
  ...
  return (
    ...
    <div className="text-white py-14 container mx-auto  bg-indigo-900 w-[600px] h-[670px] flex justify-center">
      <div className="social-login-buttons ">
      <h2 className="text-center font-bold text-2xl justify-center-safe">
        Login to Get Started
      </h2>
        <div className="flex flex-col gap-2 min-h-screen  p-10 items-center ">
          <button className="flex items-center w-64 bg-gray-200 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
          ...
          <button onClick={() => signIn("github")} className="flex items-center w-64 bg-gray-200 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
          ...
          <div className="my-5  text-center">
                        <div
                            className="leading-none px-2  text-sm text-white  font-medium   ">
                    ...
                    <div className="mx-auto max-w-xs flex flex-col items-center">
                        <input
                            className="w-64 px-8 py-4 rounded-lg text-black font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white "
                            type="email" placeholder="Email" />
                        <input
                            className="w-64 px-8 py-4 rounded-lg font-medium text-black bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5"
                            type="password" placeholder="Password" />
                            <div className="py-5">
           
                        <button
                            className="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 w-64 flex justify-center " >
                        ...
                        <p className="mt-6 text-xs text-gray-400 text-center">
                           <input type="checkbox" name="" id="" /> I agree to abide by GetMeaCoffee 
