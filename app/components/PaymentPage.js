  ...
  return (
    <>
      ...
      <div className='absolute top-[79%] right-[45%] '>
        <img className=' rounded-2xl border-[1.5px] border-white w-40 h-40 ' src={currentUser.profilepic} alt="" />
      </div>
        </div>    
        <div className="info flex flex-col justify-center items-center my-20 gap-3">
           <div className='font-bold text-xl'>@{username}</div>
           <div className='text-slate-300'>creating a queer horror podcast</div>
           <div className='text-slate-400'>723 members . 513 posts . $14,540/release</div>
           ...
           <div className="payments flex gap-3 w-[80%] mt-11">
            ...
            <div className="makepayment w-1/2 bg-slate-700 rounded-lg p-10">
              ...
              <div className="flex gap-2 flex-col">
                ...
                <button className=' bg-slate-600 p-3  text-white bg-gradient-to-r from-purple-800 to-pink-600 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex justify-center' onClick={()=>pay(paymentform.amount * 100)}>Pay</button>
