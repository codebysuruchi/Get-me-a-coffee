  ...
  const pay = async (amount) => {
    ...
    var options = {
      ...
      handler: async function (response) {
        // Mark payment as done immediately
        try {
        ...
        // Redirect with payment success flag
    ...
    <>
      ...
      <div className="cover w-full bg-reg-50 relative">
        ...
        <div className="absolute top-[45%] md:top-[76%] right-[37%] md:right-[44%] ">
          <img
            className=" rounded-full object-cover border-[1.5px] border-white w-40  h-40 "
        ...
        <div className="payments flex gap-3 w-[80%] mt-11 flex-col md:flex-row">
          ...
          <div className="makepayment w-full md:w-1/2 bg-slate-700 rounded-lg p-10">
            ...
            <div className="flex gap-2 flex-col">
              ...
              <button
                className=" bg-slate-600 p-3  text-white bg-gradient-to-r from-purple-800 to-pink-600 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex justify-center disabled:bg-slate-600 disabled:from-purple-100"
                disabled={
