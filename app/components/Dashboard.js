    ...
    <div className="container mx-auto py-5">
      ...
      <form  className="max-w-2xl mx-auto" action={handleSubmit}>
        ...
        <div className="my-2">
         ...
         {/* submit button */}
         <div className="my-6">
          <button type="submit" className="block w-full p-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm  text-center cursor-pointer ">Submit</button>
         </div>
      </form>
    </div>
  </div>;
