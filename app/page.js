  ...
  return (
    <>
      <div className="flex flex-col justify-center text-white h-[44vh] items-center px-5 md:px-0 text-xs md:text-base">
        <div className="text-xl md:text-3xl font-bold flex gap-2 md:gap-6 ">
          {" "}
          Buy Me A Coffee{" "}
          <span className="">
      ...
      <div className="text-white container mx-auto py-32 pt-14 px-10">
        ...
        <div className="flex gap-5 justify-around ">
          <div className="item space-y-3 flex flex-col items-center justify-center">
            <img
              className="bg-gray-500 rounded-full p-2 text-black "
              src="/women.gif"
              width={100}
              alt=""
            />
            <p className="text-center font-bold text-white">Fund Yourself</p>
          ...
          <div className="item space-y-3 flex flex-col items-center justify-center">
            <img
              ...
              alt=""
            />
            <p className="text-center font-bold text-white"> Fans want to help you</p>
            <p className="text-center">
              Your fans are available for you to help you
            </p>
          </div>
      ...
      <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
        ...
        <div className="w-[90%] h-[40vh] md:w-[50%] md:h-[40vh] lg:w-[50%] lg:h-[40vh] xl:w-[50%] xl:h-[40vh]">
          ...
          <Link href="https://my-portfolio-website-alpha-five.vercel.app/" target="_blank">
          <img className="cursor-pointer" src="/portfolio.png" alt="" />
          </Link>
        </div>
      </div>
    </>
